...
>
    ...
    <div
        x-show="show"
        class="relative mb-6 bg-neutral-950 border border-neutral-900 rounded-2xl overflow-hidden shadow-[0_25px_60px_rgba(0,0,0,0.85)] transform transition-all w-full {{ $maxWidth }} mx-auto"
        x-transition:enter="ease-out duration-300"
