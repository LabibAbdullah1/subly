<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" class="space-y-4">
        ...
        <p class="text-center text-sm text-gray-500 mt-6 pt-2">
            Already registered? 
            <a href="{{ route('login') }}" class="text-white hover:text-primary-400 font-medium transition-colors">Sign in here</a>
        </p>
    </form>
</x-guest-layout>
