<x-admin-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <h2 class="font-semibold text-sm text-neutral-450 tracking-wider uppercase">
                {{ __('Edit Paket') }}: <span class="text-white font-mono">{{ $plan->name }}</span>
            </h2>
        </div>
    </x-slot>
    ...
    <div class="py-6 sm:py-8 max-w-3xl mx-auto select-none px-4 sm:px-0">
        <div class="glass-panel p-6 sm:p-8 border-neutral-900">
            <div class="mb-6">
                <h3 class="text-base font-bold text-white tracking-wide">Perbarui Paket Hosting</h3>
            ...
            <form action="{{ route('admin.plans.update', $plan) }}" method="POST" class="space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <x-text-input id="duration_months" type="number" name="duration_months" :value="old('duration_months', $plan->duration_months)" class="mt-1.5 block w-full" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="max_storage_mb" type="number" name="max_storage_mb" :value="old('max_storage_mb', $plan->max_storage_mb)" class="mt-1.5 block w-full" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="max_databases" type="number" name="max_databases" :value="old('max_databases', $plan->max_databases)" class="mt-1.5 block w-full" required />
