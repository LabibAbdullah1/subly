<x-admin-layout>
    ...
    <div class="py-6 sm:py-8 max-w-3xl mx-auto select-none px-4 sm:px-0">
        <div class="glass-panel p-6 sm:p-8 border-neutral-900">
            <div class="mb-6">
                <h3 class="text-base font-bold text-white tracking-wide">Update Promo Voucher</h3>
                <p class="text-xs text-neutral-500 font-medium mt-1">Modify discount codes, reward rates, usage quotas, and expiration parameters.</p>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <select name="type" id="type" class="input-field mt-1.5 block w-full text-xs" required>
                            <option value="fixed" {{ old('type', $voucher->type) == 'fixed' ? 'selected' : '' }}>Fixed Amount (IDR)</option>
                    ...
                    <div>
                        ...
                        <x-text-input id="usage_limit" type="number" name="usage_limit" :value="old('usage_limit', $voucher->usage_limit)" class="mt-1.5 block w-full text-xs" placeholder="Unlimited if empty" />
