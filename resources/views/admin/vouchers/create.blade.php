<x-admin-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            <a href="{{ route('admin.vouchers.index') }}" class="text-neutral-450 hover:text-white transition-all duration-200 active:scale-[0.94]">
    ...
    <div class="py-6 sm:py-8 max-w-3xl mx-auto select-none px-4 sm:px-0">
        <div class="glass-panel p-6 sm:p-8 border-neutral-900">
            <div class="mb-6">
                <h3 class="text-base font-bold text-white tracking-wide">Buat Voucher Promo</h3>
                <p class="text-xs text-neutral-500 font-medium mt-1">Tambah kode diskon, persentase potongan, kuota penggunaan, dan parameter kedaluwarsa.</p>
            </div>
            ...
            <form action="{{ route('admin.vouchers.store') }}" method="POST" class="space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <x-text-input id="code" type="text" name="code" :value="old('code')" class="mt-1.5 block w-full uppercase font-mono text-xs" placeholder="contoh: DISKON50" required />
                    ...
                    <div>
                        ...
                        <select name="type" id="type" class="input-field mt-1.5 block w-full text-xs" required>
                            <option value="fixed" {{ old('type') == 'fixed' ? 'selected' : '' }}>Nominal Tetap (IDR)</option>
                    ...
                    <div>
                        ...
                        <x-text-input id="usage_limit" type="number" name="usage_limit" :value="old('usage_limit')" class="mt-1.5 block w-full text-xs" placeholder="Tak terbatas jika dikosongkan" />
