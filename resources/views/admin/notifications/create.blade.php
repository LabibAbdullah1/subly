    ...
    <div class="py-6 sm:py-8 max-w-4xl mx-auto select-none px-4 sm:px-0 space-y-6">
        ...
        <div class="glass-panel overflow-hidden border-neutral-900" x-data="{ target: 'all', sending: false }">
            <div class="p-6 border-b border-neutral-900 bg-neutral-950/40">
                <h3 class="text-base font-bold text-white tracking-wide">Buat Pengumuman Klien</h3>
                <p class="text-xs text-neutral-500 font-medium mt-1">Siarkan peringatan prioritas tinggi ke kotak notifikasi dashboard akun target.</p>
            </div>
            ...
            <form action="{{ route('admin.notifications.store') }}" method="POST" class="p-6 sm:p-8 space-y-5" @submit="sending = true">
                ...
                @if(session('success'))
                    <div class="p-4 rounded-xl bg-neutral-900 border border-neutral-850 flex items-center gap-3 animate-fade-in mb-4">
                        ...
                        <div>
                            <p class="text-xs font-bold text-white tracking-wide">Siaran Terkirim</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div class="space-y-2">
                        <label class="block text-[11px] font-bold text-neutral-450 uppercase tracking-wider">Penerima Target</label>
                        <div class="flex gap-4 mt-1.5">
                            <label class="relative flex-1 flex items-center justify-center gap-3 cursor-pointer p-4 rounded-xl border transition-all duration-200 outline-none select-none active:scale-[0.98]"
                                ...
                                <div class="flex flex-col">
                                    <span class="text-xs font-bold transition-colors" :class="target === 'all' ? 'text-white' : 'text-neutral-450'">Semua Klien</span>
                                    <span class="text-[9px] text-neutral-500 font-semibold mt-0.5">Siarkan ke semua</span>
                                </div>
                            </label>
                            ...
                            <label class="relative flex-1 flex items-center justify-center gap-3 cursor-pointer p-4 rounded-xl border transition-all duration-200 outline-none select-none active:scale-[0.98]"
                                ...
                                <div class="flex flex-col">
                                    <span class="text-xs font-bold transition-colors" :class="target === 'specific' ? 'text-white' : 'text-neutral-450'">Pengguna Spesifik</span>
                                    <span class="text-[9px] text-neutral-500 font-semibold mt-0.5">Target satu klien</span>
                                </div>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="space-y-2" x-show="target === 'specific'" x-cloak x-transition>
                        <label for="user_id" class="block text-[11px] font-bold text-neutral-450 uppercase tracking-wider">Pilih Pengguna Target</label>
                ...
                <div class="space-y-2">
                    <label for="message" class="block text-[11px] font-bold text-neutral-450 uppercase tracking-wider">Konten Pesan</label>
                    <textarea name="message" id="message" rows="5" required
                        ...
                        placeholder="Tulis detail pesan notifikasi di sini..."></textarea>
                    <div class="flex items-center justify-between mt-1">
                        <p class="text-[9px] text-neutral-500 font-semibold italic">Batas maksimum 1000 karakter.</p>
        ...
        <div class="glass-panel p-5 border-neutral-900 border-l-2 border-l-white">
            <div class="flex items-start gap-4">
                ...
                <div>
                    <h4 class="text-xs font-bold text-white tracking-wide">Referensi Penggunaan</h4>
                    <p class="text-[10px] text-neutral-500 font-semibold leading-relaxed mt-1">
                        Gunakan siaran notifikasi untuk memberi tahu klien tentang jadwal pemeliharaan database/server yang direncanakan, pengumuman perubahan penagihan mendatang, atau respons langsung terhadap tiket bantuan mendesak. Item yang dikirim menyebar secara instan ke lingkungan yang ditargetkan.
                    </p>
                </div>
            </div>
        </div>
