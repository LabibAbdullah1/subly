<x-admin-layout>
    ...
    <div class="py-6 sm:py-8 max-w-3xl mx-auto select-none px-4 sm:px-0">
        <div class="glass-panel p-6 sm:p-8 border-neutral-900">
            <div class="mb-6">
                <h3 class="text-base font-bold text-white tracking-wide">Register Client Account</h3>
                <p class="text-xs text-neutral-500 font-medium mt-1">Create user profile credentials and assign initial access roles.</p>
            </div>
            ...
            <form action="{{ route('admin.users.store') }}" method="POST" class="space-y-5">
                ...
                <div class="grid grid-cols-1 gap-5">
                    <div>
                        ...
                        <x-text-input id="name" type="text" name="name" :value="old('name')" class="mt-1.5 block w-full" placeholder="e.g. John Doe" required />
                    ...
                    <div>
                        <x-input-label for="password" :value="__('Password')" class="text-neutral-455 text-[11px] font-bold uppercase tracking-wider" />
