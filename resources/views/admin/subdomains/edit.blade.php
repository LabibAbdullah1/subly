<x-admin-layout>
    ...
    <div class="py-6 sm:py-8 max-w-3xl mx-auto select-none px-4 sm:px-0 space-y-6">
        <div class="glass-panel p-6 sm:p-8 border-neutral-900">
            <div class="mb-6">
                <h3 class="text-base font-bold text-white tracking-wide">Update Subdomain Host</h3>
                <p class="text-xs text-neutral-500 font-medium mt-1">Modify target client, directory paths, and status configurations.</p>
            </div>
            ...
            <form action="{{ route('admin.subdomains.update', $subdomain) }}" method="POST" class="space-y-5">
                ...
                <div class="grid grid-cols-1 gap-5">
                    ...
                    <div>
                        ...
                        <p class="text-[10px] text-neutral-500 font-semibold italic mt-1.5">Changing this will update cPanel document paths. Use with caution for active environments.</p>
                    ...
                    <div>
                        ...
                        <p class="text-[10px] text-neutral-500 font-semibold italic mt-1.5">The absolute path to the subdomain's root directory on the server.</p>
        ...
        <div class="glass-panel p-5 border-neutral-900 border-l-2 border-l-white">
             ...
             <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs mt-3.5 select-all">
                <div>
                    <span class="text-neutral-500 font-semibold uppercase tracking-wider text-[10px] block mb-1">Doc Root Path:</span>
                ...
                <div>
                    <span class="text-neutral-500 font-semibold uppercase tracking-wider text-[10px] block mb-1">External Domain Link:</span>
