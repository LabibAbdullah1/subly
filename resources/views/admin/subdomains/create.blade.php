                ...
                <form action="{{ route('admin.subdomains.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="doc_root" id="doc_root" value="{{ old('doc_root') }}" 
                            ...
                            <p class="text-xs text-gray-500 italic">The absolute path to the subdomain's root directory on the server. If left empty, it will be automatically calculated.</p>
