<x-admin-layout>
    ...
    <div class="py-6 sm:py-8 max-w-3xl mx-auto select-none px-4 sm:px-0">
        <div class="glass-panel p-6 sm:p-8 border-neutral-900">
            <div class="mb-6">
                <h3 class="text-base font-bold text-white tracking-wide">Perbarui Kredensial</h3>
                <p class="text-xs text-neutral-500 font-medium mt-1">Ubah rincian akses database untuk {{ $database->subdomain->full_domain }}.</p>
            </div>
            ...
            <form action="{{ route('admin.databases.update', $database) }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <p class="mt-2 text-[10px] text-neutral-500 font-semibold tracking-wide">Catatan: Password ini dapat diubah dengan aman tanpa memengaruhi tabel data yang ada.</p>
                </div>
