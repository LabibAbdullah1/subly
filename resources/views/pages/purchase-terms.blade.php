            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div x-show="lang === 'id'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform translate-y-4" x-transition:enter-end="opacity-100 transform translate-y-0" style="display: none;">
                    <div class="mb-12 text-center text-balance select-none">
                        ...
                        <p class="text-xs sm:text-sm text-neutral-500 font-medium">Harap baca dengan saksama sebelum bertransaksi.</p>
                    </div>
                    ...
                    <div class="glass-panel p-8 md:p-12 prose prose-invert prose-neutral max-w-none text-neutral-300 text-xs sm:text-sm font-medium leading-relaxed prose-headings:text-white prose-headings:font-bold prose-headings:tracking-tight prose-strong:text-white">
                        ...
                        <div class="bg-red-500/5 border border-red-500/10 rounded-xl p-5 mb-8 not-prose">
                            <div class="flex gap-3">
                                ...
                                <div>
                                    <h3 class="text-red-400 font-bold mb-1 text-sm">Kebijakan Ketat Tanpa Pengembalian Dana</h3>
                                    <p class="text-red-200/80 text-xs sm:text-sm leading-relaxed">Apabila layanan atau akun Anda ditangguhkan akibat pelanggaran Ketentuan Layanan—termasuk, yang utamanya, tindakan mengunggah file berbahaya, skrip ilegal, atau malware—<strong class="text-white">TIDAK ADA PENGEMBALIAN DANA (NO REFUNDS)</strong> yang akan diberikan dalam kondisi apa pun untuk sisa periode masa berlangganan Anda.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <p class="text-xs text-neutral-500 mt-12 pt-8 border-t border-neutral-900">Dengan membeli paket dari Subly, Anda telah memberikan persetujuan digital untuk tunduk sepenuhnya di bawah Syarat Pembelian dan Pengembalian Dana ini.</p>
                    </div>
                </div>
                ...
                <div x-show="lang === 'en'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform translate-y-4" x-transition:enter-end="opacity-100 transform translate-y-0" style="display: none;">
                    <div class="mb-12 text-center text-balance select-none">
                        ...
                        <p class="text-xs sm:text-sm text-neutral-500 font-medium">Please read carefully before transacting.</p>
                    </div>
                    ...
                    <div class="glass-panel p-8 md:p-12 prose prose-invert prose-neutral max-w-none text-neutral-300 text-xs sm:text-sm font-medium leading-relaxed prose-headings:text-white prose-headings:font-bold prose-headings:tracking-tight prose-strong:text-white">
                        ...
                        <div class="bg-red-500/5 border border-red-500/10 rounded-xl p-5 mb-8 not-prose">
                            <div class="flex gap-3">
                                ...
                                <div>
                                    <h3 class="text-red-400 font-bold mb-1 text-sm">Strict No-Refund Policy for TOS Violations</h3>
                                    <p class="text-red-200/80 text-xs sm:text-sm leading-relaxed">In the event your account or server is suspended due to violations of our Terms of Service or Application Rules—specifically including, but not limited to, the uploading of malicious, illegal, or dangerous files—<strong class="text-white">NO REFUNDS</strong> will be provided under any circumstances for the remaining period of your subscription.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <p class="text-xs text-neutral-500 mt-12 pt-8 border-t border-neutral-900">By purchasing any plan from Subly, you digitally sign and consent to strictly follow these Purchase and Refund terms.</p>
                    </div>
                </div>
