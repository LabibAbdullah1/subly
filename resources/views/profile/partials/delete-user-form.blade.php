<section class="space-y-6">
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6 bg-gray-900 border border-gray-800 rounded-xl">
            @csrf
            @method('delete')
            ...
            <div class="mt-6 flex justify-end">
                ...
                <x-danger-button class="ms-3 border border-red-900/50 shadow-[0_0_15px_rgba(220,38,38,0.15)]">
                    {{ __('Delete Account') }}
                </x-danger-button>
            </div>
        </form>
